...
if __name__ == '__main__':
   ...
   #configuration parameter
	...
	parser.add_argument('--gpu', action='store_true', help='Whether use gpu')#help: 使用这个参数描述选项作用
	...
	parser.add_argument('--bert_model_dir', type=str, default='./model/chinese-bert_chinese_wwm_pytorch/')#bert模型
	...
	for i in range(args.epoch):
		...
		if (dev_acc[1] + dev_acc[2]) / 2 > best_mean:
			...
			best_mean_idx = i + 1
			torch.save(model.state_dict(), model_save_path) #save and loads only the model parameters
